...
public class MemberWindow {
	...
	public static void constructWindow() {
		...
		JFrame jFrameMember = new JFrame("Member");															// create a frame.
		...
		JLabel userLabel3 = new JLabel("Campus Address");												// Create label
		...
		JLabel userLabel4 = new JLabel("Home Address");												// Create label
		...
		JLabel userLabel5 = new JLabel("PhoneNo");												// Create label
		...
		JLabel userLabel6 = new JLabel("Card Number");												// Create label
		...
		JLabel userLabel7 = new JLabel("Is Professor");												// Create label
		userLabel7.setBounds(20, 210, 195, 14);
		jFrameMember.getContentPane().add(userLabel7);			
				
		String[] isProfStrings = { "Yes", "No"};
		JComboBox jIsProfListComboBox = new JComboBox(isProfStrings);
		jIsProfListComboBox.setBounds(145, 210, 188, 20);
		jFrameMember.getContentPane().add(jIsProfListComboBox);
		...
		jButtonSend.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				boolean isProf;
				if(jIsProfListComboBox.equals("Yes"))
					isProf=true;
				else 
					isProf=false;
				MemberDao.save(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), jTextField5.getText(), jTextField6.getText(), isProf);	
			}
		});

...
public class ReturnBookWindow {
	...
	public static void constructWindow() {
		...
		JFrame jFrameMember = new JFrame("Return Book");															// create a frame.
		...
		JButton jButtonSend = new JButton("Return");												//Button for Exit functionality
		jButtonSend.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
					IssueBookDao.returnBook(jTextField1.getText());	
					ReceiptReturnBookWindow.constructWindow(jTextField1.getText());
